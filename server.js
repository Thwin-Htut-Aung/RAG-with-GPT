...
const systemPrompt = "You are a friendly customer service assistant who proactively helps customers with product information at your store. When listing products, only say what the products are. You also answer general questions.";
...
io.on('connection', (socket) => {
  ...
  socket.emit('chat response', { 
    ...
    content: "Hello! I am here to help you shop at Jumpstart electronics. How can I help you today?",
  ...
  socket.on('chat message', async (message) => {
    try {
      ...
      ragString += await queryDatabase(message)
      ragString += "\n"
      ragString += "Message:\n"
      ragString += message
      ragString += "\n"
